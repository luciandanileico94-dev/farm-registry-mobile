...
export default function App() {
  ...
  if (!loaded) return <SafeAreaView style={[styles.safe, Platform.OS === 'web' && styles.safeWeb]}><View style={styles.center}><Text style={styles.loadingTitle}>Se încarcă registrul local…</Text><Text style={styles.muted}>Pregătesc fixtures sintetice și coada offline.</Text></View></SafeAreaView>;
...
const styles = StyleSheet.create({
  safeWeb: { width: '100%', maxWidth: 430, alignSelf: 'center', marginLeft: 'auto', marginRight: 'auto', borderLeftWidth: 1, borderRightWidth: 1, borderColor: '#dbe7e1' },
