...
const styles = StyleSheet.create({
  webStage: { flex: 1, width: '100%', alignItems: 'center', backgroundColor: '#edf3ef' }, safeWeb: { width: '100%', maxWidth: 430, borderLeftWidth: 1, borderRightWidth: 1, borderColor: '#dbe7e1' },
