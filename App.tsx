...
const styles = StyleSheet.create({
  webStage: { flex: 1, position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, width: Dimensions.get('window').width, alignItems: 'center', backgroundColor: '#edf3ef' }, safeWeb: { width: '100%', maxWidth: 430, borderLeftWidth: 1, borderRightWidth: 1, borderColor: '#dbe7e1' },
