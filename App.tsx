...
export default function App() {
  ...
  if (!loaded) return <SafeAreaView style={styles.safe}><View style={styles.center}><Text style={styles.loadingTitle}>Se încarcă registrul local…</Text><Text style={styles.muted}>Pregătesc fixtures sintetice și coada offline.</Text></View></SafeAreaView>;
